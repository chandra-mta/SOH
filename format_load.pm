...
printf SF "<TR><TD ALIGN=LEFT><FONT SIZE=2 COLOR=%s>PFTANK3T </FONT></TD>\n", ${$h{PFTANK3T}}[3];
printf SF "<TD ALIGN=LEFT><FONT SIZE=2 COLOR=%s>%7.2f </FONT></TD>\n", ${$h{PFTANK3T}}[3], ${$h{PFTANK3T}}[1];

printf SF "<TR><TD ALIGN=LEFT></TR>\n";
printf SF "<TR><TD ALIGN=LEFT></TR>\n";
printf SF "<TR><TD ALIGN=LEFT></TR>\n";
printf SF "<TR><TD ALIGN=CENTER COLSPAN=2><FONT SIZE=4>OBA FORWARD BULKEAD TEMPERATURES</FONT></TR>\n";
